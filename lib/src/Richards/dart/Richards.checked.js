...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Richards: {
      "^": "BenchmarkBase;name",
      run$0: function() {
        var t1, scheduler, t2, t3;
        t1 = [Y.TaskControlBlock];
        t1 = H.assertSubtype(H.setRuntimeTypeInfo(new Array(6), t1), "$isList", t1, "$asList");
        ...
        t2.state = 0;
        t3 = [P.int];
        t2 = new Y.TaskControlBlock(t2, 1, 1000, new Y.Packet(new Y.Packet(null, 1, 1, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), 1, 1, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), new Y.WorkerTask(2, 0, scheduler), null);
        t2.state = 3;
        scheduler.currentTcb = t2;
        scheduler.list = t2;
        t1[1] = t2;
        t2 = new Y.TaskControlBlock(t2, 2, 2000, new Y.Packet(new Y.Packet(new Y.Packet(null, 4, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), 4, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), 4, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), new Y.HandlerTask(null, null, scheduler), null);
        t2.state = 3;
        scheduler.currentTcb = t2;
        scheduler.list = t2;
        t1[2] = t2;
        t2 = new Y.TaskControlBlock(t2, 3, 3000, new Y.Packet(new Y.Packet(new Y.Packet(null, 5, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), 5, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), 5, 0, 0, H.assertSubtype(new Array(4), "$isList", t3, "$asList")), new Y.HandlerTask(null, null, scheduler), null);
        t2.state = 3;
        scheduler.currentTcb = t2;
        scheduler.list = t2;
        t1[3] = t2;
    ...
    Scheduler: {
      ...
      queue$1: function(packet) {
        var t = C.JSArray_methods.$index(this.blocks, packet.id);
        if (t == null)
          return t;
        ++this.queueCount;
        packet.link = null;
...
//# sourceMappingURL=Richards.checked.js.map
